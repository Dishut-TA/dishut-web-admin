      ...
      <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-sm font-bold text-[#185325] hover:underline self-start">
        ...
        {isKonfirmasiMode && (
          <div className="flex flex-col sm:flex-row gap-4 border-t border-gray-100 pt-8 mt-8">
            <button className="flex-1 py-3.5 bg-[#FF0000] hover:bg-red-700 text-white font-bold rounded-full transition-colors shadow-sm"
            >
              Tolak dan Revisi
            </button>
            <button className="flex-1 py-3.5 bg-[#185325] hover:bg-[#123d1c] text-white font-bold rounded-full transition-colors shadow-sm"
            >
