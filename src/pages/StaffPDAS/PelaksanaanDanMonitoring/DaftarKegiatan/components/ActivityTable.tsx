...
const getStatusBadge = (status: Activity['status']) => {
  ...
  switch (status) {
    case 'Berjalan':
      return (
        <span className={`${baseStyle} bg-[#e8f5e9] text-[#2E7D32]`}>
          Berjalan
        </span>
      );
    ...
    case 'Bermasalah':
      return (
        <span className={`${baseStyle} bg-red-50 text-red-600`}>
          Bermasalah
        </span>
      );
        ...
        <table className="w-full text-left border-collapse min-w-225">
          <thead>
            <tr className="bg-[#DCECE0] text-[#3A4D3F] text-[11px] font-bold uppercase tracking-wider border-b border-gray-100">
              ...
              <th className="px-6 py-4 whitespace-nowrap min-w-37.5">
                Progress
              </th>
                ...
                >
                  ...
                  <td className="px-6 py-4 text-center whitespace-nowrap">
                    <button
                      ...
                      onClick={() =>
                        navigate(
                          `/admin/staff/monitoring/kegiatan/detail/${kegiatan.id}`
                        )
                      }
