...
export default function ViewValidasiLokasi({ status, activeId }: Props) {
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col">
          ...
          <div className="flex gap-6 items-center flex-1">
            ...
            <div className="w-1/3 flex flex-col gap-4 text-sm">
              ...
              <button className="mt-2 py-2 px-3 border border-emerald-600 text-emerald-700 font-bold text-xs rounded-lg flex items-center justify-center gap-2 hover:bg-emerald-50 transition-colors cursor-pointer"><HiOutlineMap className="w-4 h-4" /> Lihat di Peta</button>
            </div>
          </div>
        </div>
      </div>
