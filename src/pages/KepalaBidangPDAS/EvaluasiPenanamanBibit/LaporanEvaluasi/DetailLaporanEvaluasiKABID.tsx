      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-10">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 border-b border-gray-200 pb-6 mb-8">
          <div>
            ...
            <p className="text-xs font-bold text-[#185325] mt-2">Periode: {dataLaporan.periode}</p>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex gap-3 text-sm text-blue-800">
             <p className="font-medium">
               Dokumen ini telah sah secara birokrasi. Berita Acara resmi (lengkap dengan persentase tumbuh, dan tanda tangan) dapat diunduh dengan menekan tombol <strong>Cetak Berita Acara</strong> di atas.
             </p>
          </div>
        </div>
