...
const MOCK_DATA = [
  { id: 'LK-001', no: 1, periode: 'Jan - Juni 2025', investasi: 'Ekowisata Kebun Stroberi', pendapatan: 'Rp 120.000.000', pengeluaran: 'Rp 80.000.000', laba: 'Rp 40.000.000', status: 'Diverifikasi' },
  { id: 'LK-002', no: 2, periode: 'Jan - Juni 2025', investasi: 'Ekowisata Kebun Stroberi', pendapatan: 'Rp 120.000.000', pengeluaran: 'Rp 80.000.000', laba: 'Rp 40.000.000', status: 'Revisi' },
];

const LaporanKeuanganKABIDBUPM: React.FC = () => {
          ...
          <table className="w-full text-left border-collapse min-w-max">
            <thead className="bg-[#DCECE0] text-[#3A4D3F] text-xs uppercase tracking-wider font-bold border-b border-gray-200">
              <tr>
                ...
                <th className="px-6 py-4 whitespace-nowrap">Total Pendapatan</th>
                <th className="px-6 py-4 whitespace-nowrap">Total Pengeluaran</th>
              ...
              {MOCK_DATA.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4 flex justify-center whitespace-nowrap">
                    <button 
                      title="Lihat Detail"
                      onClick={() => navigate(`/admin/kabid/bupm/laporan-keuangan/detail/${item.id}`)}
...
export default LaporanKeuanganKABIDBUPM;